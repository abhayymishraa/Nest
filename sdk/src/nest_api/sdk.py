...
import httpx
import importlib
from nest_api import models
from nest_api._hooks import SDKHooks
from nest_api.types import OptionalNullable, UNSET
from typing import Any, Callable, Optional, TYPE_CHECKING, Union, cast
import weakref

if TYPE_CHECKING:
    from nest_api.github import GitHub
    from nest_api.owasp import Owasp


class NestAPI(BaseSDK):
    r"""OWASP Nest API: API for OWASP related entities"""

    git_hub: "GitHub"
    owasp: "Owasp"
    _sub_sdk_map = {
        "git_hub": ("nest_api.github", "GitHub"),
        "owasp": ("nest_api.owasp", "Owasp"),
    }
